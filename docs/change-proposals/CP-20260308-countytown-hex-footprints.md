...
- 当前问题：县城主视图虽然已经切到 hex 地表，但住宅与场所底座、高亮与阴影仍保留菱形 footprint，整体观感还不够统一。
- 证据（数据/玩家反馈）：在上一轮县城 hex 俯瞰落地后，建筑和场所底座仍明显保留旧等距痕迹。
...
- 验证方式：
  ...
  - 运行 Godot，检查县城建筑底座、场所高亮、选中命中区与遮挡顺序
