...
- 当前问题：虽然主地图入口已经压缩为天衍峰山门图与世界地图，但天衍峰山门图内部仍残留“县城 / 市集 / 学宫 / 官署 / 茶肆”等县城语义。
- 证据（数据/玩家反馈）：本轮继续推进“双地图”后，用户明确要求继续实现，而下一个最直接的缺口就是天衍峰山门图内部语义尚未彻底宗门化。

## 改动内容

- 改什么：
  - 新增 `SectMapSemanticRules`；
  - 将场所标签切换为 `阵材圃 / 傀儡工坊 / 山门坊市 / 传法院 / 庶务殿 / 论道亭`；
...
- 预期提升指标：
  - 天衍峰山门图主观感知更统一；
  - 后续接入山门、药园、演武场、传法院等资产时，不需要先回头清理旧县城文案。
- 可接受副作用：
