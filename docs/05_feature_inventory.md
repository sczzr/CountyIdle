...
| 宗门弟子独立属性界面（弟子谱） | ✅ | `CountyIdle/scripts/models/DiscipleProfile.cs`、`CountyIdle/scripts/systems/DiscipleRosterSystem.cs`、`CountyIdle/scripts/systems/CountyTownMapViewSystem.cs`、`CountyIdle/scripts/systems/CountyTownMapViewSystem.Residents.cs`、`CountyIdle/scripts/ui/DisciplePanel.cs`、`CountyIdle/scripts/ui/MainDisciplePanel.cs`、`CountyIdle/scripts/Main.cs`、`CountyIdle/scenes/ui/DisciplePanel.tscn`、`CountyIdle/scenes/ui/WorldPanel.tscn` | `docs/02_system_specs.md` |
| 宗门组织谱系展示（JobsList 对齐设定） | ✅ | `CountyIdle/scripts/systems/SectOrganizationRules.cs`、`CountyIdle/scripts/systems/SectTaskRules.cs`、`CountyIdle/scripts/Main.cs`、`CountyIdle/scenes/ui/JobsPanel.tscn` | `docs/02_system_specs.md` |
| 宗门组织谱系详情浏览（JobsList 二期） | ✅ | `CountyIdle/scripts/systems/SectOrganizationRules.cs`、`CountyIdle/scripts/Main.cs`、`CountyIdle/scenes/ui/JobsPanel.tscn` | `docs/02_system_specs.md` |
| 峰脉协同法旨（JobsList 三期） | ✅ | `CountyIdle/scripts/models/SectPeakSupportType.cs`、`CountyIdle/scripts/systems/SectPeakSupportRules.cs`、`CountyIdle/scripts/systems/SectPeakSupportSystem.cs`、`CountyIdle/scripts/systems/SectOrganizationRules.cs`、`CountyIdle/scripts/systems/EconomySystem.cs`、`CountyIdle/scripts/systems/PopulationSystem.cs`、`CountyIdle/scripts/systems/IndustrySystem.cs`、`CountyIdle/scripts/core/GameLoop.cs`、`CountyIdle/scripts/Main.cs`、`CountyIdle/scenes/ui/JobsPanel.tscn` | `docs/02_system_specs.md` |
...
| 仓库管理独立入口（Esc 关闭 + 提示条） | ✅ | `CountyIdle/scripts/Main.cs`、`CountyIdle/scripts/ui/MainWarehousePanel.cs`、`CountyIdle/scripts/ui/WarehousePanel.cs`、`CountyIdle/scripts/ui/PopupPanelBase.cs`（当前仓储弹窗已补成按分类滚动卡槽展示，每格显示正式材料图片、整数库存，并支持紧缺高亮/筛选） | `docs/02_system_specs.md` |
